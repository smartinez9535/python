...
print(x) # error --> actually none


#6
def add(b,c):
    print(b+c) # 3, 5
print(add(1,2) + add(2,3)) # none + none --> actually error, no prints
...
foobar()
print(b) # 300
# chronological 500 500 300 300 --> actually 500 500 300 500
